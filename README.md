...
**Sports Betting • Scissors • Crash • Mines • Turtle • Plinko • Dice • Slot Game • Lottery • Roulette • Blackjack • Poker • Baccarat**
...
| **Sports Betting** | Live sports betting with real-time odds, multiple sports, and bet slip functionality | ![Sports Betting](images/sports-betting.webp) |
| **Lottery** | Draw-based lottery system with multiple prize tiers and crypto payouts | ![Lottery](images/lottery.webp) |
| **Roulette** | Classic European roulette with crypto betting and real-time wheel spinning | ![Roulette](images/roulette.webp) |
| **Blackjack** | Traditional card game with crypto stakes and multiple betting options | ![Blackjack](images/blackjack.webp) |
| **Poker** | Multi-variant poker games with crypto buy-ins and tournament support | ![Poker](images/poker.webp) |
| **Baccarat** | Elegant card game with crypto betting and multiple side bet options | ![Baccarat](images/baccarat.webp) |
...
* Multiple game types (Crash, Dice, Mines, Scissors, Slot, Plinko, Turtle Race, Lottery, Roulette, Blackjack, Poker, Baccarat)
* Provably fair gaming with seed-based randomness
* Instant game results and payouts
* Game history and statistics
* Sports betting with live odds and bet slip functionality
